...
class Keys {
    companion object {
        ...
        @JvmStatic
        val CHANNEL_ID = "app.carching/carching_locator_plugin"

        @JvmStatic
        val BACKGROUND_CHANNEL_ID = "app.carching/locator_plugin_background"
        ...
        @JvmStatic
        val NOTIFICATION_ACTION = "co.carching.carching_background_locator.notification"
    }
}