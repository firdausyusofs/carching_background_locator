...
import com.carching.carching_background_locator.pluggables.DisposePluggable
import com.carching.carching_background_locator.pluggables.InitPluggable
import com.carching.carching_background_locator.pluggables.Pluggable
import com.carching.carching_background_locator.provider.*
...
class IsolateHolderService : MethodChannel.MethodCallHandler, LocationUpdateListener, Service() {
    ...
    private var notificationMsg = "Tracking location in background"
    ...
    private fun getNotification() : Notification {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(Keys.CHANNEL_ID, notificationChannelName, NotificationManager.IMPORTANCE_LOW)
        ...
        val pendingIntent: PendingIntent = PendingIntent.getActivity(this, 1, intent, PendingIntent.FLAG_IMMUTABLE or PendingIntent.FLAG_UPDATE_CURRENT)
