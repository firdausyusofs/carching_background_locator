...
static CarchingBackgroundLocatorPlugin *instance = nil;
...
+ (void)registerWithRegistrar:(nonnull NSObject<FlutterPluginRegistrar> *)registrar {
    @synchronized (self) {
        if (instance == nil) {
            instance = [[CarchingBackgroundLocatorPlugin alloc] init:registrar];
...
+ (CarchingBackgroundLocatorPlugin *)getInstance {
    return instance;
}
...
- (void)observeRegionForLocation:(CLLocation *)location {
    ...
    CLRegion *region = [[CLCircularRegion alloc] initWithCenter:location.coordinate radius:distanceFilter identifier:@"region"];
...
-(instancetype)init:(NSObject<FlutterPluginRegistrar> *)registrar {
    ...
    _mainChannel = [FlutterMethodChannel methodChannelWithName:kChannelId binaryMessenger:[registrar messenger]];
    
    [registrar addMethodCallDelegate:self channel:_mainChannel];
    
    _callbackChannel = [FlutterMethodChannel methodChannelWithName:kBackgroundChannelId binaryMessenger:[_headlessRunner binaryMessenger]];
...
- (void)registerLocator:(int64_t)callback 
  ...
  initialDataDictionary:(NSDictionary *)initialDataDictionary 
    ...
    if (@available(iOS 11.0, *)) {
        [_locationManager setShowsBackgroundLocationIndicator:showsBackgroundLocationIndicator];
    }
